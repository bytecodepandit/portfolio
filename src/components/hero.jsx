...
export default function Hero() {
  const skills = ['Backend Developer', 'Frontend Developer', 'Creative Coder', 'Tech Enthusiast'];
  const greetings = ["Hello", "Hola", "नमस्ते", "مرحبا"];
      ...
      <div className="relative z-20 flex items-center justify-center w-full h-full p-8 text-center bg-black/20 pointer-events-none sm:p-16 md:p-24">
        <div className="max-w-md pointer-events-auto">
          ...
          <div className="flex justify-center gap-4 mt-8">
            ...
            <a
              href="https://drive.google.com/file/d/19OIvRPHgk33QxWhuJU7aqofY2OONg5jq/view?usp=sharinghttps://drive.google.com/file/d/1ghyDIpJftOrMTYHSO7bAyzZ5HXS1vj-V/view?usp=sharing"
              target="_blank"
