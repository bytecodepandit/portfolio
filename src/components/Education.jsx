          ...
          <div className="relative flex max-w-lg mx-auto flex-col items-center justify-center overflow-hidden rounded-lg border bg-background p-4">
            ...
            >
              <Folder element="My Education" value="Education">
                <Folder element="Delhi University" value="KU">
                  <File value="KU-MCA">
                    <p>Bachelor of Computer Application (2011 – 2014)</p>
                  </File>
                </Folder>
                <Folder element="Sarvodaya Bal Vidyalaya" value="MC">
                  <File value="MC-BCA">
                    <p>Higher Secondary (2011)</p>
                  </File>
                </Folder>
                 <Folder element="Government boys Senior Secondary School No.2 " value="BHS">
                   <File value="BHS-Matric">
                    <p>Matriculation (2009)</p>
                  </File>                   
                </Folder>
              </Folder>
