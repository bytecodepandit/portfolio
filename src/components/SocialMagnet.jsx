...
const SOCIALS = [
  { name: 'LinkedIn', url: 'https://www.linkedin.com/in/prakash-mandal-5b25651bb/', icon: ICONS.LinkedIn },
  { name: 'GitHub', url: 'https://github.com/bytecodepandit', icon: ICONS.GitHub },
  { name: 'X', url: 'https://x.com/BytecodeP', icon: ICONS.Twitter },
  { name: 'Mail', url: 'mailto:bytecodepandit@gmail.com', icon: ICONS.Mail },
];
